...
def main():
    ...
    """
    file = open('../data/sinais_com_label.csv')
    """
    ...
    #Run ID3
    tree = ArvoreDecisao.makeTree(data, attributes, target, 0)
    print("generated decision tree")
    #Generate program
    file = open('program.py', 'w')
    file.write("from arvore_decisao import Node\n\n")
    #open input file
    file.write("data = [[]]\n")
    """
    IMPORTANT: Change this file path to change testing data 
    """
    file.write("f = open('../data/sinais_sem_label.csv')\n")
    #gather data
